...
def context(
    ...
    pages: List[Page] = []
    context = browser.new_context(**browser_context_args, storage_state="auto/cookies.json", locale="zh-CN")
    # 设置全局超时40秒
...
def init(page):
    ...
    login_config = bs_init.read_yaml("auto/config.yaml", "$..formal_root_login")
    bs_init.logger.info(
