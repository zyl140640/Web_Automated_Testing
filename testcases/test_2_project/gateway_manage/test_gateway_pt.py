...
class TestGatewayPT:
    ...
    def test_add_gateway_pt(self, page):
    ...
    def test_get_gateway_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_update_gateway_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_delete_gateway_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_batch_addition_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_batch_update_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_save_as_template(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_batch_gateway_pt(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_yinyong_template(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
    ...
    def test_template_download(self, page):
        self.sidebar = SidebarPage(page)
        self.gateway_pt = GatewayPTPage(page)
        self.sidebar.click_project_max()
        self.sidebar.click_gateway()
