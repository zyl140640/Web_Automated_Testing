...
class TestGatewayPT:
    ...
    def test_add_gateway_pt(self):
        ...
        self.gateway_pt.add_gateway_pt(self.read_yaml_data['gateway_pt_value'], "1011")
    ...
    def test_get_gateway_pt(self):
        ...
        self.sidebar.get_project_name(self.read_yaml_data['project_name'])
        self.sidebar.click_more_functions("点表配置")
        self.gateway_pt.get_gateway_pt(self.read_yaml_data['gateway_pt_value'])
    ...
    def test_update_gateway_pt(self):
        ...
        self.sidebar.click_more_functions("点表配置")
        self.gateway_pt.get_gateway_pt(self.read_yaml_data['gateway_pt_value'])
        self.gateway_pt.update_gateway_pt(self.read_yaml_data['gateway_pt_value'])
