...
class TouchScreenPage(BasePage):
    def add_touch_screen(self, name):
        ...
        self.click(self.page.locator("li").filter(has_text="设备3").first, "选择所属网关")
        ...
        self.asserts_result(self.get_text(self.page.get_by_role("alert"), "获取添加触摸屏结果"), "=",
                            "保存成功")
    ...
    def update_touch_screen(self, name):
        ...
        self.input_data(self.page.get_by_placeholder("请输入触摸屏名称").last, f"{name}", "触摸屏名称")
        self.click(self.page.get_by_role("button", name="确 定"), "确定按钮")
        self.asserts_result(self.get_text(self.page.get_by_role("alert"), "获取修改触摸屏结果"), "=",
                            "保存成功")
    ...
    def delete_touch_screen(self):
        ...
        self.asserts_result(self.get_text(self.page.get_by_role("alert"), "获取删除触摸屏结果"), "=",
                            "删除成功")
